...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.navigation_style'
        db.add_column('cmsplugin_gallery', 'navigation_style',
                      self.gf('django.db.models.fields.CharField')(default='NONE', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.navigation_style'
        db.delete_column('cmsplugin_gallery', 'navigation_style')
    ...
    models = {
        ...
        'djangocms_gallery.gallery': {
            ...
            'navigation_style': ('django.db.models.fields.CharField', [], {'default': "'NONE'", 'max_length': '255'}),
        ...
        'djangocms_gallery.slide': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slides'", 'to': "orm['djangocms_gallery.Gallery']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['djangocms_gallery']